...
export const createCoop = createAsyncThunk("coop/createCoop", async (id) => {
  try {
    const res = await Axios.post(`/coop/${id}`);
...
export const getCoop = createAsyncThunk("coop/getCoop", async (id) => {
  try {
    const res = await Axios.get(`/coop/${id}`);
...
export const createFlock = createAsyncThunk(
  "coop/createFlock",
  async (body) => {
    try {
      const res = await Axios.post(`/flock/${body.coopId}`, body.apiBody);
...
export const getFlock = createAsyncThunk("coop/getFlock", async (id) => {
  try {
    const res = await Axios.get(`/flock/${id}`);
...
export const addBirds = createAsyncThunk("coop/addBirds", async (body) => {
  try {
    const res = await Axios.post(`/bird/add`, body);
...
export const removeBirds = createAsyncThunk(
  "coop/removeBirds",
  async (body) => {
    try {
      const res = await Axios.post(`/bird/remove`, body);
