...
import {clearError, clearRes, createOfflineFlock} from 'store/reducers/coops';
import Loader from 'components/common/Loader';
import {createNewOfflineFlocks} from 'backgroundTask/flocks';
import {checkIfOnline} from 'utils/checkIfOnline';

import dropdownIcon from 'assets/images/dropdownMedium.png';
  ...
  const onSave = async () => {
    ...
    if (!!inputs.breed_name && !!date) {
      ...
      if (onlineStatus) {
        ...
        dispatch(createOfflineFlock(body));
      }
    } else {
      Alert.alert(
        'Empty Input',
